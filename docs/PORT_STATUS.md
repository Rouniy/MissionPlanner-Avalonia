...
- Automated tests: 1111 passed, 0 failed, including legacy Mission Planner plugin binary loading,
...
- The `.deb` target is rebuilt from the current 1111-test source on 2026-08-23. Package metadata,
